...
import { addTask } from "../../features/store";
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-8  p-5">
            <div className="py-7 px-7 text-xs font-medium tracking-wider text-left flex items-center">
              <AiOutlineNodeCollapse size={25} /> Add Task
            </div>
            ...
            <div className="py-7 px-7  flex space-x-2 justify-start">
              {task.map((task: string, index:number) => (
                <span key={index}className="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-blue-600 text-white rounded">
                  {task}
                </span>
              ))}
            </div>
